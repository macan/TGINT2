...
import { Search, Loader2, AlertCircle, Users, Calendar, Info, MessageSquare, ExternalLink, Reply, Moon, Sun } from 'lucide-vue-next'
...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    ...
    <header class="mb-8 text-center pt-8 sm:pt-0">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl mb-2">Telegram Channel Explorer</h1>
      <p class="text-gray-500 dark:text-gray-400">Discover profiles and latest posts from any public Telegram channel</p>
    </header>
